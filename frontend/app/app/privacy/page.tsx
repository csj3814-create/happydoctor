...
const policySections = [
  ...
  },
  {
    ...
    body: (
      <ul>
        ...
        <li><strong>이용자가 선택하여 제출하는 정보:</strong> 상처·발진·약 포장 등의 사진, 답변 알림용 휴대전화번호</li>
  ...
  },
  {
    ...
    body: (
      <>
        <p>개인정보는 원칙적으로 처리 목적이 달성되거나 이용자가 적법하게 삭제를 요청하면 지체 없이 파기합니다. 답변 알림용 휴대전화번호는 알림 목적이 끝나면 우선 분리·삭제합니다.</p>

...
const policySections = [
    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li><strong>Resend:</strong> 의료진 운영 알림 메일 발송과, 선택 동의한 이용자에게 답변 알림 메일 발송. 의료진 운영 알림 메일에는 상담 본문·사진·건강정보를 포함하지 않습니다.</li>
  ...
  {
    title: '15. 방침 변경',
    body: <p>이 방침은 2026년 7월 28일 작성되었고, 2026년 9월 14일에 수탁자 목록을 최신 운영 상태에 맞추어 갱신했습니다. 국외 처리 리전, 수탁자 계약 및 법정 보존기간 검토를 마친 뒤 시행일 전에 확정 내용을 고지합니다. 중요한 변경은 적용 전에 서비스 화면을 통해 안내합니다.</p>,
  },
]

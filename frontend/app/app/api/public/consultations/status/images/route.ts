...
export async function POST(request: Request) {
  try {
    ...
    const response = await fetch(`${BACKEND_BASE_URL}/api/public/consultations/status/images`, {
      method: 'POST',
    ...
    console.error('[App Public Consultation Image Header Proxy Error]', error)
